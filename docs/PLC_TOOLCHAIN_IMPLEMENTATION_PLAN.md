...
- M2：MCP Server 最小 3 工具已实现并验证：`plc_probe_target`、`plc_read_pvi`、`plc_check_download`。

下一步：

- 继续扩展 MCP Server，封装 `plc_build_project`、`plc_start_arsim`、`plc_describe_ruc_package`。
