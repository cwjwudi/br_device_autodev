...
5. 确认 `config/targets/default-safe.json` 的 `targets.arsim.arsim_loader_exe` 指向实际生成的 `PrintDemo/Temp/Simulation/<config>/<CPU>/ar000loader.exe`，例如 `PrintDemo/Temp/Simulation/x3687x/X20CP3687X/ar000loader.exe`。
6. 启动或复用 `arsim`。
